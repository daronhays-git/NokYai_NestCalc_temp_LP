      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="#hero" className="inline-block font-display font-extrabold text-xl mb-3">
              <span className="text-white">Nok</span>
              <span className="text-nok-gold" style={{ textShadow: '0 0 20px rgba(245,158,11,0.4)' }}>Yai</span>
            </a>
            ...
            <div className="flex items-center gap-1">
              {/* GitHub */}
              <a href="#" aria-label="GitHub" className="p-2 text-nok-caption hover:text-nok-gold transition-colors duration-200">
              ...
              {/* X / Twitter */}
              <a href="#" aria-label="X" className="p-2 text-nok-caption hover:text-nok-gold transition-colors duration-200">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="#" aria-label="LinkedIn" className="p-2 text-nok-caption hover:text-nok-gold transition-colors duration-200">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="border-t border-nok-border/50 pt-8 mt-12 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-nok-caption">
            &copy; 2026 NokYai.com. All rights reserved.
          </p>
          <p className="text-sm text-nok-caption">
